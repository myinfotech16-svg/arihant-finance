...
function serviceDetailHTML(service) {
  ...
  return `
    <section class="service-hero" style="background-image: linear-gradient(rgba(36,18,70,0.3), rgba(36,18,70,0.45)), url('images/service-hero/${service.id}.jpg'); background-size: cover; background-position: center;">
      <div class="container">
